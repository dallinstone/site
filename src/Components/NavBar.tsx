  ...
  return (
    <header className="site-header">
      ...
      <div className="nav-shell">
        <Link className="brand" to="/" aria-label="Danny Stone, home"><span className="brand__mark" aria-hidden="true">DS</span><span className="brand__name"><strong>Danny Stone</strong><small>Software engineer</small></span></Link>
        <div className="nav-actions">
          <nav id="primary-navigation" className={`primary-nav${isOpen ? " primary-nav--open" : ""}`} aria-label="Primary navigation">
            ...
            <Link className="nav-contact" to="/#contact">Say hello ↗</Link>
          </nav>
